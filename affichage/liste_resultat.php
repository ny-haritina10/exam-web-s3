<?php
    ...
    $res = Cueillette::get_global_result($dt_min, $dt_max);
?>
                    ...
                    <tbody>
                        <?php foreach ($res as $row): ?>
                            <tr>
                                ...
                                <td><?php echo $row['poids_cueillette_total']; ?></td>
                                <td><?php echo $row['poidsRestants']; ?></td>
                                <td><?php echo $row['cout_de_revient_par_kg']; ?></td>
                                <td><?php echo $row['Montant_des_depenses']; ?></td>
                                <td><?php echo $row['Montant_vente']; ?></td>

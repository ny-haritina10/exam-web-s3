                    ...
                    <div class="contact-form">
                        <form id="depense-form">
                            <div class="form_group" id="name_field">
                                ...
                                <label style="color: white;" for="input-variete">Date</label>
                            ...
                            <div class="form_group" id="email_field">
                                ...
                                <label style="color: white;" for="occupation">Depense</label>                                
                                <div class="input_field">
                            ...
                            <div class="form_group" style="width: 100%">
                                ...
                                <label style="color: white;" for="rendement">Montant</label>

...
<body>
    ...
    <section id="home-slider">
        ...
        <div class="slider-waper">
            ...
            <div class="single-slide-item slider-bg-1 bg-overlay" style="background-image: url(./front-office/assets/img/slider/slider-2.jpg);">
                <div class="container">
                        ...
                        <div class="teashop-table-cell">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="#product" class="teashop-btn">Visit Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="section-header text-center">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            ...
                            specimen book. It has survived.scrambled it to make a type specimen book. It has survived
                        </p>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-product-box">
                        ...
                        <div class="product-photo">
                            <div class="teashop-table">
                                <div class="teashop-table-cell">
                                    <img src="./front-office/assets/img/picking.jpeg" alt="Product Photo">
                                </div>
                            </div>
                        </div>
                        <a class="teashop-btn" href="saisie_cueillette.php">Saisie des cueillettes</a>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-product-box">
                        ...
                        <div class="product-photo">
                            <div class="teashop-table">
                                <div class="teashop-table-cell">
                                    <img src="./front-office/assets/img/spending.jpg" alt="Product Photo">
                                </div>
                            </div>
                        </div>
                        <a class="teashop-btn" href="saisie_depense.php">Saisie des dépenses</a>
                    </div>
                </div>
                <!-- Ends Single Product Box Here -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-product-box">
                        ...
                        <div class="product-photo">
                            <div class="teashop-table">
                                <div class="teashop-table-cell">
                                    <img src="./front-office/assets/img/res.jpg" alt="Product Photo">
                                </div>
                            </div>
                        </div>
                        <a class="teashop-btn" href="resultat.php">Resultat</a>
                    </div>
                </div>
                <!-- Ends Single Product Box Here -->
            </div>
    ...
    <div class="g-map cd-google-map" hidden>
